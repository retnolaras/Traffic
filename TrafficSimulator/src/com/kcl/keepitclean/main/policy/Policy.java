...
public class Policy {
   ...
   -  TRAFFICLIGHTFROM/TRAFFICLIGHTTO: ARRAY OF TRAFFIC LIGHT TIMING SETTINGS: [1]: GREEN; [2]: AMBER; [3]: RED
	...
	private static SpeedLimit speedLimit;
	...
	public static double getJunctionSpeedLimit(){
		return speedLimit.junction;

	}    
	
	public static double getStraightRoadSpeedLimit(){
		return speedLimit.straightRoad;

	} 
	
	public static double getCurvyRoadSpeedLimit(){
		return speedLimit.curvyRoad;

	}
	
	public static int getGreenTrafficLightTime(){
		return trafficLight.green;
	}
	
	public static int getAmberTrafficLightTime(){
		return trafficLight.amber;
	}
	
	public static int getRedTrafficLightTime(){
