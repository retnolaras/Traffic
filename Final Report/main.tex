...
\begin{enumerate}
	...
	Many of the early abstractions decided on by the team were clean, robust, and reusable. Such as the abstraction that a 'Road' is just an environment that a 'vehicle can either be on or not, or that a traffic management 'policy' is a rule or set of rules to be plugged into a simulation.
