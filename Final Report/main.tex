...
One of the main motives for building microscopic traffic flow models is that to later integrate them to build macroscopic models. An example of a comprehensive microscopic traffic flow simulator is defined by Namekawa et al in \cite{NameUeda05Due to the prominence of purpose-specific simulators ,Namekawa's project aimed at building a general purpose database of road units, with infomation about width, road signs and general measurements. They code was designed so  that it would be resused and integrated to build a macroscopic traffic model.The model the road network with variable width proportions and different road divisions; such as sidelines and center lanes.
...
Although this was not directlu relevant to our project since we neither planned to implement lane changes and 3D modelling, but it made us more concious about our decisions about flow and speed of the simulation.
...
\subsubsection{System Requirements}
  ...
  From the system requirements, the product roadmap is as below:
      ...
      \begin{table}[h]
        ...
        \begin{tabular}{l|l}
             ...
             FT16- Simulate- simulate vehicle moving straight & MUST HAVE \\ \hline
             FT17- Simulation Engine- simulate vehicle moving at junctions& MUST HAVE \\ \hline
             FT18- Simulation Engine- simulate vehicles at traffic lights & MUST HAVE \\ \hline
             FT19- Simulation Engine- simulate vehicles accelerate/decelerate & SHOULD HAVE \\ \hline
             FT20- Simulation Engine- simulate different traffic density & MUST HAVE \\ \hline
             FT20- Simulation Engine- simulate vehicles following traffic policy & MUST HAVE \\ \hline
             FT20- Simulation Engine- simulate different drivers' classes of behaviours & MUST HAVE \\ \hline
             FT21- GUI- GUI Layout & MUST HAVE \\ \hline
             FT22- GUI- User simulation settings & MUST HAVE \\ \hline
             FT23- GUI- Draw roads & MUST HAVE \\ \hline
             FT24- GUI - Draw junctions & MUST HAVE \\ \hline
             FT25- GUI- Draw traffic lights & MUST HAVE \\ \hline
             FT25- GUI- Draw vehicles & MUST HAVE \\ \hline
             FT26- GUI- Rendering & MUST HAVE \\ \hline
