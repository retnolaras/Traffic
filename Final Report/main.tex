...
\begin{center}
	...
	\begin{tabular}{|m{7cm}|m{7cm}|}
		...
		\multicolumn{2}{ |>{\columncolor[gray]{0.8}}c|}{\textbf{JUnit Testing}} \\ \hline 
		 ...
		 LaneSection & 
		 \includegraphics[width=\textwidth]{TestLaneSection}
		 
		 \\ \hline
		 Policy & \\ \hline
		 Road & \\ \hline
		 SimulationData & \\ \hline
		 Vehicle & \\ \hline
