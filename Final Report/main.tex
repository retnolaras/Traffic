...
Although this was not directly relevant to our project since we neither planned to implement lane changes and 3D modelling, but it made us more concious about our decisions about flow and speed of the simulation.
...
\subsubsection{GUI}
GUI is implemented using JavaFX. The class diagram of GUI is as below:
    \begin{figure}[H]
    ...
    This class is to layout UI components. GUIComponents extends BorderPane to set Left Pane for Simulation and Right Pane for User Settings and Report. 
    ...
    User inputs validation and get user inputs methods are also implemented in this class. They would be executed in InitScreen to response to user actions. 
    
    \paragraph{Renderer}
    IRenderer interface is used in SimuationEngine to render simulation objects onto the GUI. render method is called on initalising the simulation and every simulation step to draw map and vehicles
